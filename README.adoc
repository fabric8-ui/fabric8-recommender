...
To build the app and start in standalone mode, please run the command
----
$ npm start
----

This starts the app at the url `http://localhost:8088` and we can bring the app up with the url format which is below

```
http://localhost:8088/#/analyze/<REQUEST_ANALYSIS_ID>?api_data={
